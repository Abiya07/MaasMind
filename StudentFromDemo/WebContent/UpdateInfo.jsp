...
<body>
	...
	<form name="Loginform" action="UpdateServlet" method="get">	
	<input type="hidden" name="id" value=<%=request.getParameter("id")%> >
	Name:<input type="text" name="name" value=<%=request.getParameter("name")%> onkeypress="return validateinput(this,event)"/><br>
	Age:<input type="text"  maxlength=2 name="age" value=<%=request.getParameter("age")%>  onkeypress="return validateinput(this,event)"/><br>
	Phonenumber:<input type="text" maxlength=10 name="phonenumber" value=<%=request.getParameter("phonenumber")%> onkeypress="return validateinput(this,event)"/><br>
	Email:<input type="text" name="email" value=<%=request.getParameter("email")%> /><br>
	Date of join:<input type="text" name="doj" value=<%=request.getParameter("doj")%> /><br/>
